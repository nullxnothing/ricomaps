  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setData(result.data);
        setCirculatingSupply(result.stats?.supplyConcentration?.circulatingSupplyUsed);
      } catch (err) {
  ...
  return (
    <div className="relative w-full h-full" style={{ background: 'var(--bg-void)' }}>
      <div className="absolute inset-0">
        <BubbleMap data={data} onNodeClick={handleNodeClick} circulatingSupply={circulatingSupply} />
      </div>
